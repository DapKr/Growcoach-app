      ...
      <main className="landing-main">
        ...
        >
          <div className="hero-overlay">
            ...
            <p className="hero-subtitle">בלי שיווק, בלי רשתות, בלי לרדוף אחרי לקוחות</p>
            <p className="hero-description">
              <span className="hero-description-alt-font"><span className="hero-description-alt-font-color">Grow</span>Coach</span> מחברת בין מדריכי הורים מקצועיים לבין הורים שמחפשים את המדריך המדויק עבורם. הורים מגיעים אלינו עם צורך ברור,
              מחפשים ליווי יעיל ואיכותי.
...
<section className='landing-list-section'>
      ...
      <div className="cta-desktop">
        <div className="fab-container">
          ...
          <div className="cta-caption">משתמש קיים? <a href="/login">כניסה למערכת</a></div>
        </div>
      </div>
      </div>
