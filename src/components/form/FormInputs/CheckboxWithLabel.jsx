...
export default function CheckboxWithLabel({ name, label, description, required = false }) {
  const {
    register,
    formState: { errors }
  } = useFormContext();
  ...
  return (
    <div className={`form-field-wrapper checkbox-wrapper ${error ? 'has-error' : ''}`} dir="rtl">
